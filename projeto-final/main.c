...
void emprestarLivro(Livro *livros, int totalLivros)
{
    // mudar a val do emprestado pra 1 e precisa verificar se jÃ¡ nÃ£o estÃ¡ emprestado;

    printf("Escolha o metédo de buscas:");
    printf("1. ISBN\n");
    printf("2. Autor\n");
    printf("3. Titulo\n");
...
void devolverLivro(Livro *livros, int totalLivros)
{
    ...
    printf("Escolha o método de buscas:");
    printf("1. ISBN\n");
    printf("2. Autor\n");
    printf("3. Título\n");
...
void carregarDados(Livro *livros, int *totalLivros)
{
    ...
    *totalLivros = 0;
    ...
    // Adicione mensagens de depuraÃ§Ã£o
